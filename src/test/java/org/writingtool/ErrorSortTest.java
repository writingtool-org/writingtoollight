...
public class ErrorSortTest {
  ...
  public void testIsCorrectSortTest() {
    ...
    SingleProofreadingError[] aError = new SingleProofreadingError[11];
  ...
  private SingleProofreadingError createError(String id, int start, int length, int numSuggestion) {
