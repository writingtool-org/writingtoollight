...
//  @Ignore("see https://github.com/languagetool-org/languagetool/issues/4064")
  ...
  public void testCleanFootnotes() {
    ...
    assertEquals("A house.¹ Here comes more text.", WtSingleDocument.cleanFootnotes("A house.1 Here comes more text."));
    assertEquals("A road that's 3.4 miles long.", WtSingleDocument.cleanFootnotes("A road that's 3.4 miles long."));
    assertEquals("A house.1234 Here comes more text.", WtSingleDocument.cleanFootnotes("A house.1234 Here comes more text."));  // too many digits for a footnote
    ...
    assertEquals(expected, WtSingleDocument.cleanFootnotes(input));
  }
